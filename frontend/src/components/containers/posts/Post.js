...
const Post = (props) => {
  ...
  return (
    <div className='post'>
      <div className='user_profile' style={{ display: `${userProfile}` }} onMouseOver={displayUserProfile} onMouseOut={hideUserProfile}>
        <div>
          <div></div>
          <h4>{user_name}</h4>
        </div>
        <div className='user_profile-btns'>
          <button type="button"><span><i class='bx bxs-user-plus' ></i></span>Add friend</button>
          <button type="button"><span><i class='bx bxs-user-circle' ></i></span>View profile</button>
        </div>
      </div>
      <div className="post_top">
        <div className='post_profile' onMouseOver={displayUserProfile} onMouseOut={hideUserProfile}>
