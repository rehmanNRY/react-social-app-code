  ...
  return (
    <div className='setProfilePic'>
      <div className="setProfile_main">
        <button type="button" onClick={navigatetoHome} className="setProfile_clsBtn"><X/></button>
        ...
        <div className="setProfile_form">
          <form action="" onSubmit={handleSubmit}>
            <input type="text" value={pictureLink} onChange={handleInputChange} required autoComplete='off' placeholder="Enter Picture link" />
            <button type="submit"><PlusSquare/>Update Dp</button>
          </form>
        </div>
      </div>
    </div>
